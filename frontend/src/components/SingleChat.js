...
import { Box, FormControl, IconButton, Input, position, Spinner, Text, useToast } from '@chakra-ui/react'
...
const SingleChat = ({fetchAgain, setFetchAgain}) => {
    ...
    return (
        <>
            {selectedChat ? (
                <>
                    <Text fontSize={{base:"28px",md:"30px"}} pb={3} px={2} w="100%" fontFamily="Work sans" justifyContent={{base:"space-between"}} display="flex" alignItems="center">
